            ...
            <div className="left">
                <motion.div className="title" variants={titleVariants} initial="initial" animate="animate">
                    <motion.h1 variants={titleVariants}>
                        ...
                        Digital <motion.span variants={titleVariants}> Marketing</motion.span> With 
                ...
                <motion.div className="text" variants={textVariants} initial="initial" animate="animate">
                    <motion.p variants={textVariants}>
                        ...
                        The <span>leading agency</span> for expert <span>Meta & Google ad</span> campaigns and <br />
                        top-notch <span>web development</span> services.
                    </motion.p>
                </motion.div>
